...
* [Troposphere + ECS](https://github.com/cloudtools/troposphere/blob/master/examples/ECSFargate.py) ⭐ 4,944 | 🐛 163 | 🌐 Python | 📅 2026-09-19 - For Python users [Troposphere](https://github.com/cloudtools/troposphere) ⭐ 4,944 | 🐛 163 | 🌐 Python | 📅 2026-09-19 can help create CloudFormation templates. This example shows how to create an ECS deployment using Troposphere
...
* [ecspresso](https://github.com/kayac/ecspresso) ⭐ 1,125 | 🐛 18 | 🌐 Go | 📅 2026-09-19 - Minimalistic: JSON file goes in, service launches

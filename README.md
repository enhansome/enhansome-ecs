...
* [ecs-deploy](https://github.com/silinternational/ecs-deploy) ⭐ 1,982 | 🐛 1 | 🌐 Shell | 📅 2026-07-01 - Simple but powerful tool for initiating automatic blue green deploys on ECS
...
* [ecspresso](https://github.com/kayac/ecspresso) ⭐ 1,128 | 🐛 20 | 🌐 Go | 📅 2026-09-21 - Minimalistic: JSON file goes in, service launches
...
* [kms-env](https://github.com/ukayani/kms-env) ⭐ 18 | 🐛 2 | 🌐 JavaScript | 📅 2023-04-18 - CLI tool for managing secrets using AWS KMS in .env files which can be used in conjunction with **ecs-service** to supply secrets to your containers
...
* * [empire](https://github.com/remind101/empire) ⭐ 2,676 | 🐛 90 | 🌐 Go | 📅 2023-11-25 - Control layer on top of ECS that provides a Heroku like workflow
...
* [Mythical Misfits](https://github.com/aws-samples/amazon-ecs-mythicalmysfits-workshop) ⭐ 338 | 🐛 28 | 🌐 HTML | 📅 2025-09-12 - Deploy a sample application to serverless AWS Fargate capacity

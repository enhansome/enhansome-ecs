...
* [Troposphere + ECS](https://github.com/cloudtools/troposphere/blob/master/examples/ECSFargate.py) ⭐ 4,945 | 🐛 163 | 🌐 Python | 📅 2026-08-07 - For Python users [Troposphere](https://github.com/cloudtools/troposphere) ⭐ 4,945 | 🐛 163 | 🌐 Python | 📅 2026-08-07 can help create CloudFormation templates. This example shows how to create an ECS deployment using Troposphere
...
* [ecspresso](https://github.com/kayac/ecspresso) ⭐ 1,113 | 🐛 23 | 🌐 Go | 📅 2026-08-10 - Minimalistic: JSON file goes in, service launches
